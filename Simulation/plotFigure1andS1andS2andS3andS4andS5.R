...
# Figure S3: family = "cox" and p = 20
# Figure S4: family = "cox" and p = 50
# Figure S5: family = "cox" and p = 100
...
for(family in c("gaussian", "cox")){
    for(p in c(20, 50, 100)){
        ...
        result.sivcm.unweighted <- matrix(nrow = 100, ncol = 14)
        for (seed in 1:100) {
        ...
        result.sivcm.weighted <- matrix(nrow = 100, ncol = 14)
        for (seed in 1:100) {
